...
class Flash implements ArrayAccess, Arrayable, Jsonable, JsonSerializable, Renderable, Htmlable
{
    ...
    public function __construct(FlashMessageFactoryContract $flashMessageFactory, StorageContract $messagesStorage, FlashRendererContract $laraflashRenderer)
    {
    ...
    {
        $this->messages = Collection::make($this->messagesStorage->get())->whereInstanceOf(FlashMessage::class);
